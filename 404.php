            ...
            <div class="site-wrapper-inner">
                ...
                <div class="cover-container">
                    ...
                    <div id="formLogin" class="inner cover text-center animated" data-animation="fadeIn" data-animation-delay="100">
                        ...
                        <h1 class="font-montserrat cover-heading mb20 mt75">Упс...<br>Здесь ничего нет</h1><br><br>
                        <h1 style="font-size: 200px" class="color-pasific"><strong>404</strong></h1>
                        <br>
                        <a href="/"> <buttom class="button button-md button-rounded button-pasific hover-icon-back" style="margin-top: 75px;">На главную<i class="fa fa-long-arrow-left"></i></buttom></a>
                    </div>

                    <div class="mastfoot">
                        <div class="inner">
                            <p class="color-dark text-center">&copy;2016 Бери-Дари</p>
                        </div>
                    </div>
