...
$(document).ready(function() {
    ...
    $(function(){
        ...
        if( $(".navbar-standart").length > 0 ){
            $(".navbar-pasific").addClass("top-nav-collapse").addClass("logoblack_my");
        } else {
            $(window).scroll(function() {
                if ($(".navbar").offset().top > 10)  {
                    ...
                    $(".navbar-pasific").removeClass("top-nav-collapse").removeClass("logoblack_my");
                }
            });
        };
    });
